...
//      // Print coordinate of keypoints
//      for(int i = 0; i < 11; i++)
//      {
//        float x = location_data.relative_keypoints(i).x() * image_size->first;
//        float y = location_data.relative_keypoints(i).y() * image_size->second;
//        cout << "##" << i << "##\n";
//
//        cout << "x" << i << ", y" << i << " : " << "(" << x << " ," << y << ")";
//        cout << "x" << i << ", y" << i << " : " << "(" << x << " ," << y << ")";
