...
::mediapipe::Status RunMPPGraph() {
  ...
  if (client == INVALID_SOCKET)
    showError("Create client failed");
...
//       if (sent == "") continue;
//       send(client, sent.c_str(), sent.length(), 0);
//       /*int length = recv(client, received, sizeof(received), 0);
//       received[length] = '\0';
